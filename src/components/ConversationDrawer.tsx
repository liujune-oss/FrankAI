            ...
            >
                ...
                <div className="px-3 py-2 border-t">
                    <button
                        ...
                        className="w-full text-xs text-muted-foreground hover:text-foreground py-2 rounded-lg hover:bg-muted transition-colors flex justify-center items-center gap-1.5"
                    >
