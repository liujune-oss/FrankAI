...
export default function MemoryManager({ open, onClose }: MemoryManagerProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            {/* Modal */}
            <div className="relative bg-background border rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                {/* Header */}
